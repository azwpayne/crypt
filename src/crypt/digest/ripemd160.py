...
# These are the first 32 bits of the fractional parts of the square roots of the first 5 primes
...
# K values for the left and right lines
_KL: Final[tuple[int, ...]] = (
...
# RIPEMD-160 word selection order for left line
_RL: Final[tuple[int, ...]] = (
    # Round 1
...
# RIPEMD-160 word selection order for right line
_RR: Final[tuple[int, ...]] = (
    # Round 1
...
# List of nonlinear functions for each round
_FUNCTIONS: Final[tuple[Callable[[int, int, int], int], ...]] = (
    _f1, _f2, _f3, _f4, _f5
)
...
def ripemd160(data: bytes | str) -> str:
    ...
    return struct.pack("<5I", *h).hex()


# Backward compatibility alias
hash = ripemd160  # noqa: A001
