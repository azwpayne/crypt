...
def encrypt(text: str, key: str = "", size: int = 5,
            row_labels: str = "", col_labels: str = "") -> str:
    """
    使用波利比奥斯方阵加密文本
...
def decrypt(encrypted_text: str, key: str = "", size: int = 5,
            row_labels: str = "", col_labels: str = "") -> str:
    """
    使用波利比奥斯方阵解密文本
