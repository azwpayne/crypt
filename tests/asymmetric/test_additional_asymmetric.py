...
class TestECC:
  ...
  def test_key_generation(self):
    ...
    from crypt.asymmetric.ecc import N, Point, generate_keypair
  ...
  def test_key_generation_unique(self):
    ...
    from crypt.asymmetric.ecc import generate_keypair
  ...
  def test_ecdh_key_exchange(self):
    ...
    from crypt.asymmetric.ecc import ecdh_shared_secret, generate_keypair
  ...
  def test_ecdsa_sign_verify(self):
    ...
    from crypt.asymmetric.ecc import ecdsa_sign, ecdsa_verify, generate_keypair
  ...
  def test_ecdsa_signature_components(self):
    ...
    from crypt.asymmetric.ecc import N, ecdsa_sign, generate_keypair
...
class TestDSA:
  ...
  def test_key_generation(self):
    ...
    from crypt.asymmetric.dsa import generate_keypair, generate_parameters
  ...
  def test_sign_verify_roundtrip(self):
    ...
    from crypt.asymmetric.dsa import generate_keypair, generate_parameters, sign, verify
  ...
  def test_signature_components(self):
    ...
    from crypt.asymmetric.dsa import generate_keypair, generate_parameters, sign
  ...
  def test_verify_invalid_signature_values(self):
    ...
    from crypt.asymmetric.dsa import generate_keypair, generate_parameters, verify
...
class TestDiffieHellman:
  ...
  def test_key_exchange_same_shared_secret(self):
    ...
    from crypt.asymmetric.diffie_hellman import (
  ...
  def test_key_exchange_different_private_keys(self):
    ...
    from crypt.asymmetric.diffie_hellman import generate_private_key, generate_public_key
  ...
  def test_key_exchange_consistency(self):
    ...
    from crypt.asymmetric.diffie_hellman import compute_shared_secret
    ...
    from crypt.asymmetric.diffie_hellman import G, P
