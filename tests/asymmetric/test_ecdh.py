...
from crypt.asymmetric.ecdh import CURVES, Point, compute_shared_secret, generate_keypair, scalar_mult
...
class TestECDH:
  ...
  def test_compute_shared_secret_infinity(self):
    ...
    from crypt.asymmetric.ecdh import Point, compute_shared_secret
  ...
  def test_point_add_identity(self):
    ...
    from crypt.asymmetric.ecdh import point_add
