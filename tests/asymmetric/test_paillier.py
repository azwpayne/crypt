...
from crypt.asymmetric.paillier import add_constant, add_encrypted, decrypt, encrypt, generate_keypair
...
class TestPaillier:
  ...
  def test_miller_rabin_small_primes(self):
    from crypt.asymmetric.paillier import _miller_rabin
  ...
  def test_generate_prime_p_equals_q_loop(self):
    ...
    from crypt.asymmetric.paillier import generate_keypair
    from unittest.mock import patch

    with patch("crypt.asymmetric.paillier._generate_prime") as mock_gen:
  ...
  def test_encrypt_r_loop(self):
    ...
    from crypt.asymmetric.paillier import encrypt
    from unittest.mock import patch
