...
import zlib
from crypt.checksum.crc.crc8 import (
  crc8,
  crc8_autosar,
  crc8_bluetooth,
  crc8_j1850,
...
from crypt.checksum.crc.crc12 import _reflect8, _reflect12, crc12, crc12_cdma2000, crc12_dect, crc12_gsm, crc12_umts
from crypt.checksum.crc.crc16 import crc16, crc16_ansi, crc16_dnp, crc16_ibm, crc16_modbus, crc16_usb, crc16_xmodem
from crypt.checksum.crc.crc16_ccitt import (
  crc16_ccitt,
  crc16_ccitt_1d0f,
  crc16_ccitt_false,
  crc16_ccitt_ffff,
...
from crypt.checksum.crc.crc32 import calculate_crc32, get_crc32
from crypt.checksum.crc.crc32c import crc32c, crc32c_castagnoli, crc32c_iscsi, crc32c_sctp
from crypt.checksum.crc.crc64 import crc64, crc64_hex
