...
class TestAESBasicOperations:
    ...
    def test_sub_bytes_inverse(self):
        ...
        original = bytearray([0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                             0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f])
        state = original.copy()
        sub_bytes(state)
    ...
    def test_mix_columns(self):
        ...
        state = bytearray([0xdb, 0x13, 0x53, 0x45,
                          0xf2, 0x0a, 0x22, 0x5c,
                          0x01, 0x01, 0x01, 0x01,
                          0xc6, 0xc6, 0xc6, 0xc6])
        mix_columns(state)
    ...
    def test_mix_columns_inverse(self):
        ...
        original = bytearray([0xdb, 0x13, 0x53, 0x45,
                             0xf2, 0x0a, 0x22, 0x5c,
                             0x01, 0x01, 0x01, 0x01,
                             0xc6, 0xc6, 0xc6, 0xc6])
        state = original.copy()
    ...
    def test_add_round_key(self):
        ...
        expected = bytearray([0xff, 0xfe, 0xfd, 0xfc, 0xfb, 0xfa, 0xf9, 0xf8,
...
class TestAESCTR:
    ...
    def test_ctr_against_pycryptodome(self, key_size):
        ...
        # PyCryptodome reference
        cipher = CryptoAES.new(key, CryptoAES.MODE_CTR, nonce=nonce, initial_value=initial_value)
