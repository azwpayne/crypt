...
class TestBlowfishVsReference:
    ...
    @pytest.mark.skipif(
        pytest.importorskip("Crypto.Cipher.Blowfish", reason="pycryptodome not installed") is None,
...
class TestTwofishVsReference:
    ...
    @pytest.mark.skipif(
        pytest.importorskip("Crypto.Cipher.Twofish", reason="pycryptodome not installed") is None,
