"""Tests for IDEA block cipher."""

import pytest

from crypt.encrypt.symmetric_encrypt.block_cipher.idea import (
    BLOCK_SIZE,
    decrypt_block,
    encrypt_block,
    idea_cbc_decrypt,
...
class TestIDEA:
    ...
    def test_key_schedule(self):
        ...
        # All subkeys should be 16-bit values
        for sk in subkeys:
            assert 0 <= sk <= 0xFFFF
    ...
    def test_cbc_mode(self):
        ...
        ciphertext = idea_cbc_encrypt(plaintext, key, iv)
        decrypted = idea_cbc_decrypt(ciphertext, key, iv)
    ...
    def test_cbc_different_ivs(self):
        ...
        ciphertext1 = idea_cbc_encrypt(plaintext, key, iv1)
        ciphertext2 = idea_cbc_encrypt(plaintext, key, iv2)
    ...
    def test_cbc_invalid_iv(self):
        ...
        with pytest.raises(ValueError):
            idea_cbc_encrypt(plaintext, key, iv)
