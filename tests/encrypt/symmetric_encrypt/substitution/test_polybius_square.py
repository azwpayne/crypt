...
class TestPolybiusEncrypt:
    ...
    def test_encrypt_with_custom_labels(self):
        ...
        result = polybius_square.encrypt(
            "HELLO", row_labels="ABCDE", col_labels="VWXYZ"
        )
...
class TestPolybiusDecrypt:
    ...
    def test_decrypt_with_custom_labels(self):
        ...
        encrypted = polybius_square.encrypt(
            "HELLO", row_labels="ABCDE", col_labels="VWXYZ"
        )
        result = polybius_square.decrypt(
            encrypted, row_labels="ABCDE", col_labels="VWXYZ"
        )
        assert result == "HELLO"
