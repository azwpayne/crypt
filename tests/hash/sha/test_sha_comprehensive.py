...
class TestSHA0:
  ...
  def test_sha0_known_vectors(self, msg, expected):
    ...
    from crypt.hash.sha import sha0
...
class TestSHA1:
  ...
  def test_sha1_vs_hashlib(self, msg):
    ...
    from crypt.hash.sha import sha1
...
class TestSha2224:
  ...
  def test_sha224_vs_pycryptodome(self, msg):
    ...
    from crypt.hash.sha import sha2_224
...
class TestSha2256:
  ...
  def test_sha256_vs_pycryptodome(self, msg):
    ...
    from crypt.hash.sha import sha2_256
...
class TestSha2384:
  ...
  def test_sha384_vs_pycryptodome(self, msg):
    ...
    from crypt.hash.sha import sha2_384
...
class TestSha2512:
  ...
  def test_sha512_vs_pycryptodome(self, msg):
    ...
    from crypt.hash.sha import sha2_512
...
class TestSha3224:
  ...
  def test_sha3_224_vs_pycryptodome(self, msg):
    ...
    from crypt.hash.sha import sha3_224
...
class TestSha3256:
  ...
  def test_sha3_256_vs_pycryptodome(self, msg):
    ...
    from crypt.hash.sha import sha3_256
...
class TestSha3384:
  ...
  def test_sha3_384_vs_pycryptodome(self, msg):
    ...
    from crypt.hash.sha import sha3_384
...
class TestSha3512:
  ...
  def test_sha3_512_vs_pycryptodome(self, msg):
    ...
    from crypt.hash.sha import sha3_512
...
class TestSHAKE128:
  ...
  def test_shake128_vs_pycryptodome(self, msg, output_len):
    ...
    from crypt.hash.sha import sha3_ke_128
...
class TestSHAKE256:
  ...
  def test_shake256_vs_pycryptodome(self, msg, output_len):
    ...
    from crypt.hash.sha import sha3_ke_256
...
class TestSHAKENonStandard:
  ...
  def test_shake224(self, msg, output_len):
    ...
    from crypt.hash.sha import sha3_ke_224
  ...
  def test_shake384(self, msg, output_len):
    ...
    from crypt.hash.sha import sha3_ke_384
  ...
  def test_shake512(self, msg, output_len):
    ...
    from crypt.hash.sha import sha3_ke_512
...
class TestSHAEdgeCases:
  ...
  def test_empty_input(self):
    ...
    from crypt.hash.sha import sha1, sha2_256, sha3_256
