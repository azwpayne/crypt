...
from crypt.symmetric.block_cipher.des import DES, des_decrypt, des_encrypt
from crypt.symmetric.block_cipher.des3 import DES3, des3_decrypt, des3_encrypt
...
class TestDES:
  ...
  def test_des_known_vectors(self, key_hex, plaintext_hex, ciphertext_hex):
    ...
    from crypt.symmetric.block_cipher.des import _bytes_to_int, _des_block_encrypt, _int_to_bytes
  ...
  def test_des_pkcs7_padding(self):
    ...
    from crypt.symmetric.block_cipher.des import _pkcs7_pad, _pkcs7_unpad
  ...
  def test_des_ecb_known_vector(self):
    ...
    from crypt.symmetric.block_cipher.des import (
      _bytes_to_int,
      _des_block_decrypt,
      _des_block_encrypt,
      _int_to_bytes,
