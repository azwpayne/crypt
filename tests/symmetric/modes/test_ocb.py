...
import re
from crypt.symmetric.modes.ocb import ocb_decrypt, ocb_encrypt
...
class TestOCBEdgeCases:
  def test_ntz_zero(self):
    from crypt.symmetric.modes.ocb import _ntz
  ...
  def test_constant_time_compare(self):
    from crypt.symmetric.modes.ocb import _constant_time_compare
