...
class TestAESComprehensive:
  ...
  def test_aes_ecb_roundtrip(self, aes_keys, test_data):
    ...
    from crypt.symmetric.block_cipher.aes import aes_ecb_decrypt, aes_ecb_encrypt
  ...
  def test_aes_cbc_roundtrip(self, aes_keys, test_data):
    ...
    from crypt.symmetric.block_cipher.aes import aes_cbc_decrypt, aes_cbc_encrypt
  ...
  def test_aes_ctr_roundtrip(self, aes_keys, test_data):
    ...
    from crypt.symmetric.block_cipher.aes import aes_ctr_crypt
  ...
  def test_aes_vs_pycryptodome(self, aes_keys):
    ...
    from crypt.symmetric.block_cipher.aes import aes_cbc_encrypt
...
class TestDESComprehensive:
  ...
  def test_des_roundtrip(self, des_key, test_data):
    ...
    from crypt.symmetric.block_cipher.des import des_decrypt, des_encrypt
...
class TestDES3Comprehensive:
  ...
  def test_des3_roundtrip(self, des3_key, test_data):
    ...
    from crypt.symmetric.block_cipher.des3 import des3_decrypt, des3_encrypt
...
class TestBlowfishComprehensive:
  ...
  def test_blowfish_roundtrip(self, test_data):
    ...
    from crypt.symmetric.block_cipher.blowfish import decrypt_cbc, encrypt_cbc
...
class TestStreamCiphers:
  ...
  def test_rc4_roundtrip(self, test_data):
    ...
    from crypt.symmetric.stream_cipher.rc4 import rc4_encrypt_decrypt
  ...
  def test_chacha20_roundtrip(self, test_data):
    ...
    from crypt.symmetric.stream_cipher.chacha20 import chacha20_decrypt, chacha20_encrypt
  ...
  def test_salsa20_roundtrip(self, test_data):
    ...
    from crypt.symmetric.stream_cipher.salsa20 import salsa20_decrypt, salsa20_encrypt
...
class TestClassicCiphers:
  ...
  def test_atbash_cipher(self):
    ...
    from crypt.classical.atbash_cipher import atbash_decrypt, atbash_encrypt
...
class TestEncryptionEdgeCases:
  ...
  def test_deterministic(self):
    ...
    from crypt.symmetric.block_cipher.aes import aes_ecb_encrypt
